...
- v3.6.0
    ...
    - The prompt tries, when it can, to work around a glitch in ZSH that causes the last line of STDOUT to disappear when the screen is redrawn (this is only a problem with multiline prompts).
